  ...
  const packages: CleaningPackage[] = [
    {
      ...
      services: ['Handwäsche außen (schonender als Waschstraße)', 'Innenreinigung (Saugen, Staubwischen, Scheibenreinigung)', 'Felgenreinigung (Bremsstaub & Teer entfernen)', 'Reifenpflege (Glanz & Schutz)'],
      price: 'ab 40€',
      duration: '45-60 Min',
      icon: Car,
      color: 'text-blue-600',
    ...
    },
    {
      ...
      services: ['Alle Basisleistungen', 'Polster- & Teppichreinigung (Shampoonieren)', 'Politur (Kratzer & matte Stellen entfernen)', 'Wachsversiegelung (Schutzschicht, Glanz)', 'Lederpflege & -aufbereitung', 'Kunststoffpflege'],
      price: 'auf Anfrage',
      duration: '3-4 Std',
      icon: Sparkles,
    ...
    },
    {
      ...
      services: ['Alle Premium-Leistungen', 'Keramikversiegelung (Langzeitschutz 2-5 Jahre)', 'Dampfreinigung (hygienisch, tiefenwirksam)', 'Ozonbehandlung (Geruchsbeseitigung)', 'Motorraumreinigung', 'Scheinwerferaufbereitung'],
      price: 'auf Anfrage',
      duration: '5-8 Std',
      icon: Star,
          ...
          <div className="bg-white/90 backdrop-blur-xl rounded-3xl shadow-silver-xl p-8 md:p-12 border border-white/50 relative overflow-hidden mb-8">
            ...
            <div className="relative z-10">
              ...
              <div className="flex flex-col sm:flex-row gap-4 justify-center">
                <button
                  onClick={() => window.open('https://wa.me/4915755485029?text=Hallo%2C%20ich%20interessiere%20mich%20f%C3%BCr%20eine%20professionelle%20Fahrzeugaufbereitung.%20Bitte%20kontaktieren%20Sie%20mich%20f%C3%BCr%20weitere%20Informationen.', '_blank')}
